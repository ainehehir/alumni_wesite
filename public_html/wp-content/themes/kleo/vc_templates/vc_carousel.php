...
if ( have_posts() ) : ?>
	...
	<div class="kleo-carousel-container <?php echo $el_class;?>">
		<div class="kleo-carousel-items kleo-carousel-post" data-autoplay="<?php echo $autoplay;?>" data-min-items="<?php echo $min_items; ?>" data-max-items="<?php echo $max_items;?>">
