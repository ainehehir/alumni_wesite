...
//                $comparison = $field['required'][1];
        ...
        public function _options_page_html() {
            ...
            if( $this->args['show_import_export'] === true ) {
                ...
                echo '<p><a href="javascript:void(0);" id="redux-import-code-button" class="button-secondary">' . __( 'Import from file', $this->args['domain'] ) . '</a></p>';
								//<a href="javascript:void(0);" id="redux-import-link-button" class="button-secondary">' . __( 'Import from URL', $this->args['domain'] ) . '</a></p>';
