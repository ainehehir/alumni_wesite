...
//Alternate Border color
$style_defaults['socket']['alt_border'] = "#333333";
...
$sections[] = array(
		...
		'fields' => array(
			...
			array(
					...
					'subtitle' => __('Paste your Google Analytics or other tracking code.<br/> This will be loaded in the footer.', 'kleo_framework'),
					'desc' => ''
			),
...
$sections[] = array(
		...
		'fields' => array(
				...
				array(
						'id' => 'show_lang_flag',
						'type' => 'switch',
						'required' => array('show_lang','equals','1'),
						'title' => __('Show language flag in menu', 'kleo_framework'), 
						'subtitle' => '',
						'default' => '1' // 1 = checked | 0 = unchecked
				),
				...
				array(
					...
					'desc' => '',
					'default' => '<em class="muted">fell free to call us</em> &nbsp;&nbsp;<i class="icon-phone"></i> +91.33.26789234 &nbsp;&nbsp;&nbsp;&nbsp;<i class="icon-envelope-alt"></i> support@seventhqueen.com'
				),
...
$sections[] = array(
	...
	'fields' => array(
			...
			array(
					...
					'subtitle' => __('Enable to show square avatars instead of rounded', 'kleo_framework'),
					'default' => '0' // 1 = checked | 0 = unchecked
			),
			 * 
			 */
...
$sections[] = array(
	...
	'fields' => array(
			...
			array(
					...
					'subtitle' => __('This will be displayed all over the site.', 'kleo_framework'),
					'validate' => 'email',
