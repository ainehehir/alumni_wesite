...
function kleo_bp_add_profile_navigation() {
	if(bp_is_user()): ?>
		<nav class="pagination-sticky members-navigation" role="navigation">
			...
			if ($prev !== "#") { ?><a rel="prev" href="<?php echo $prev; ?>" title=""><span id="older-nav"><?php _e("Previous Member",'kleo_framework');?></span></a><?php }
			if ($next !== "#") { ?><a rel="next" href="<?php echo $next; ?>" title=""><span id="newer-nav"><?php _e("Next Member",'kleo_framework');?></span></a><?php }
			?>
		</nav><!-- .navigation -->
	<?php endif;
}
