...
jq(document).ready( function() {
	...
	jq("#mark_as_read, #mark_as_unread").click(function() {
		...
		var checkboxes = jq("#message-threads li .mark-item input[type='checkbox']");
	...
	jq( 'body.messages #item-body div.messages' ).on( 'change', '#message-type-select', function() {
		...
		var checkboxes = jq( "li input[type='checkbox']" );
	...
	/* Header Profile and Group toggle */
	jq('.toggle-header').click(function(){
		...
		jq(".plupload html5").on('FilesAdded', function() {
			console.log('added');
		});
...
/*
var isoInterval;
function checkMyIsotope(){
	if( jq('#groups-dir-list #groups-list, #members-dir-list #members-list').is(':visible') 
					&& jq('#groups-dir-list #groups-list, #members-dir-list #members-list').css('display') == 'block' 
					&& jq('#groups-dir-list #groups-list, #members-dir-list #members-list').css('visibility') != 'hidden' ) {
