...
<div class="hr-title hr-full hr-double"><abbr><?php _e( 'Change Avatar', 'buddypress' ); ?></abbr></div>
  ...
  <blockquote>
	...
	<form action="" method="post" id="avatar-upload-form" class="standard-form" enctype="multipart/form-data">
		...
		<?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
			...
			<p><?php _e( 'Click below to select a JPG, GIF or PNG format photo from your computer and then click \'Upload Image\' to proceed.', 'buddypress' ); ?></p><br />
