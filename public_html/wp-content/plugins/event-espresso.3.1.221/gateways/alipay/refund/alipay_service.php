...
class alipay_service {
	...
	function alipay_service($parameter,$security_code,$sign_type = "MD5",$transport= "https") {
		...
		$this->parameter['_input_charset']='iso-8859-1';
		if($this->transport == "https") {
			$this->gateway = "http://www.alipay.com/cooperate/gateway.do?";
		} else $this->gateway = "https://www.alipay.com/cooperate/gateway.do?";
		$sort_array = array();
		$arg = "";
	...
	//实现多种字符编码方式
	function charset_encode($input,$_output_charset ,$_input_charset ="iso-8859-1" ) {
		$output = "";
