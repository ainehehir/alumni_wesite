		...
		elseif ( $new_user != 'no' ) :
					if ( current_user_can( 'create_users' ) ){
						...
						if ($multisite_message){
							$registerFilterArray['wpmuRegistrationMessage1'] = '<p class="success">' . sprintf(__( 'An email has been sent to the administrator, and your membership is pending approval by the administrator.', 'profilebuilder'), $userdata['user_email']) . '</p><!-- .success -->';
...
<?php			
				...
				if ( current_user_can( 'create_users' ) && $registration ) :
					$registerFilterArray['alertMessage1'] = '<p class="alert">'. __('Business registration page.', 'profilebuilder') .'</p><!-- .alert -->';
...
<?php 					
						...
						$registerFilterArray2['name1'] = '<p class="registerNameHeading"><strong>'. __('', 'profilebuilder') .'</strong></p>';
						...
						if ($wppb_defaultOptions['nickname'] == 'show'){
							...
							$registerFilterArray2['name5'] = '
								<p class="nickname'.$errorVar.'">
									<label for="nickname">'. __('Company Name', 'profilebuilder') .$errorMark.'</label>
						...
						$registerFilterArray2['info1'] = '<p class="registerContactInfoHeading"><strong>'. __('', 'profilebuilder') .'</strong></p>';
						...
						$registerFilterArray2['ay1'] = '<p class="registerAboutYourselfHeader"><strong>'. __('', 'profilebuilder') .'</strong></p>';
